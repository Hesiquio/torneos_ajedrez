    ...
    for (const m of matches) {
        ...
        await db.execute({
            ...
            args: [
                ...
                whiteCurrentId,
                blackCurrentId,
                (_a = m.result) !== null && _a !== void 0 ? _a : null,
                0
            ]
        });
        matchesInserted++;
